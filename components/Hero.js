    ...
    <section className="relative w-full min-h-screen bg-[#021a0f] overflow-hidden px-[5vw] pb-[10vh]">
      ...
      <div className="absolute top-[18vh] left-1/2 transform -translate-x-1/2 z-40 flex flex-wrap justify-center gap-[1vw] w-full max-w-[90vw]">
        <Image
          ...
          width={160}
          height={44}
          className="w-[20vw] max-w-[160px] h-auto"
        />
        <Image
      ...
      {/* Left dildo */}
      <div className="absolute bottom-[10vh] left-[calc(50%-38vw)] z-30 w-[20vw] max-w-[288px]">
        <Image
      ...
      {/* Right dildo */}
      <div className="absolute bottom-[10vh] right-[calc(50%-38vw)] z-50 w-[20vw] max-w-[288px]">
        <Image
