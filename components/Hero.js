  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-r from-[#021a0f] to-[#003321] overflow-hidden px-4 pb-12">
      ...
      <Image
        ...
        width={460}
        height={460}
        className="absolute top-[160px] right-[60px] z-30 opacity-100 brightness-[1.8]"
      />
      ...
      <div className="absolute top-[100px] left-1/2 transform -translate-x-1/2 z-40 flex flex-wrap justify-center gap-2">
        <Image src="/assets/asset_3.png" alt="Buy $DILDO" width={90} height={28} />
        <Image src="/assets/asset_4.png" alt="Community" width={90} height={28} />
        <Image src="/assets/asset_5.png" alt="NFT" width={90} height={28} />
        <Image src="/assets/asset_6.png" alt="Dildo Shop" width={90} height={28} />
      </div>
      ...
      <div className="relative z-40 flex justify-center mt-[60px]">
