...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen bg-[#021a0f] overflow-hidden px-4 pb-12">
      ...
      {/* Navigation buttons */}
      <div className="absolute top-[11vw] left-1/2 transform -translate-x-1/2 z-40 flex flex-wrap justify-center gap-4">
      ...
      <div className="absolute top-[18vw] left-1/2 transform -translate-x-1/2 z-40 w-[61vw]">
      ...
      <div className="absolute bottom-[5vw] left-1/2 transform -translate-x-[calc(50%+33vw)] z-30 w-[20vw] max-w-[288px]">
        <Image
      ...
      <div className="absolute bottom-[5vw] right-1/2 transform translate-x-[calc(50%+33vw)] z-50 w-[20vw] max-w-[288px]">
        <Image
