  ...
  return (
    <section className="relative w-full min-h-screen bg-[#021a0f] overflow-hidden px-4 pb-12">
      ...
      <Image
        ...
        width={288}
        height={552}
        className="absolute bottom-[80px] left-[calc(50%-550px)] z-30 hidden md:block"
      />
      <Image
        ...
        width={288}
        height={552}
        className="absolute bottom-[80px] right-[calc(50%-550px)] z-50 hidden md:block"
      />

      {/* Mobile scaled version - safe variant */}
      <div className="md:hidden scale-[0.45] origin-top-left min-w-[1440px] overflow-x-auto">
